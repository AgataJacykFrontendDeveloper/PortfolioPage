      ...
      Web Design
        ...
        <div class="div7">
          <a href="https://agatajacyk.github.io/MyPage/index.html"
            >
            <div class="project_box">
            <img class="project_image" src="/projects/mypage.gif" alt="My old page"
          />
          <div class="overlay">
    <div class="text_info"><p>My old Page</p>
    HTML, CSS, JavaScript,<br> 
    Bootstrap,<br> 
  Responsive Web Design</div>
  </div></div></a>
    ...
    <img class="border" src="/cream.png" />
  </div>
</template>
...
.div17 { grid-area: 6 / 1 / 7 / 2; }
.div18 { grid-area: 6 / 2 / 7 / 3; }
.div19 { grid-area: 6 / 3 / 7 / 4; }
}
